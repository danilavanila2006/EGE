...
'''
print(bin(248)) # определяем маску
print(bin(133)) # смотрим цифры по маске
print(bin(208)) # остаток цифр
print(int('10111010000', 2)) # переводим адрес в десятичную систему 
# 1488 
